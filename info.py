...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7826299591 7754709357 6727651675').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002197077992').split()]
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003842048266'))
...
OWNER = int(os.environ.get("OWNER", "7826299591"))
...
UPDATE_CHANNEL = int(environ.get('UPDATE_CHANNEL', '-1002493915757'))
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003746720259'))
VERIFY_IMG = environ.get("VERIFY_IMG", "https://i.ibb.co/xqNtSMpS/photo-2025-09-18-15-24-38-7551450511015149572.jpg")
TUTORIAL = environ.get("TUTORIAL", "https://t.me/Howtodownloadhindiin")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/Howtodownloadhindiin")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/Howtodownloadhindiin")
SHORTENER_API = environ.get("SHORTENER_API", "f5f8932d349c2b0d5b425cfa1b2fdde21316f117")
